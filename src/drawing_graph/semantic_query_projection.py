    ...
    def project_observations(
        ...
        return tuple(
            SemanticObservationSummary(
                ...
                contract_version=getattr(item, "contract_version", None),
                preprocessing_version=getattr(item, "preprocessing_version", None),
    ...
    def project_interpretations(
        ...
        return tuple(
            SemanticInterpretationSummary(
                ...
                image_hash=getattr(item, "image_hash", None),
                model_profile=getattr(item, "model_profile", None),
                model_version=getattr(item, "model_version", None),
